...
export default function HomePostCard({ post }) {
  return (
    <div className='group relative w-full border dark:border-teal-500 border-gray-500 hover:border-2 h-[350px] overflow-hidden rounded-lg sm:max-w-[365px] transition-all items-center justify-center'>
